...
COPY "%DRIVELETTER%:\GPSV\AuditPolicy\Audit.ini" "C:\Users\ESSAdmin\Desktop"
ECHO COPIED AUDIT POLICY TO DESKTOP
COPY "%DRIVELETTER%:\GPSV\SecurityConfigurations\security.csv" "C:\Users\ESSAdmin\Desktop"
ECHO COPIED SECURITY CONFIGURATIONS TO DESKTOP
XCOPY /E /I /Y "%DRIVELETTER%:\GPSV\GroupPolicyObjects" "C:\Windows\System32\GroupPolicy"
