...
XCOPY /E /I /Y "%DRIVELETTER%:\NICE_SERVER\GPSV\GroupPolicyObjects" "C:\Windows\System32\GroupPolicy"
...
IF /I %USER_INPUT%==1 (NETSH ADVFIREWALL IMPORT %DRIVELETTER%:\NICE_SERVER\FIREWALL\ACS_Galaxy\Galaxy_ACS_SVR_Firewall_Rules_Final.wfw)
IF /I %USER_INPUT%==2 (NETSH ADVFIREWALL IMPORT %DRIVELETTER%:\NICE_SERVER\FIREWALL\ACS_Gallagher\Gallagher_ACS_SVR_Firewall_Rules_Final.wfw)
IF /I %USER_INPUT%==3 (NETSH ADVFIREWALL IMPORT %DRIVELETTER%:\NICE_SERVER\FIREWALL\ACS_Genetec\Genetec_ACS_SVR_Firewall_Rules_Final.wfw)
IF /I %USER_INPUT%==4 (NETSH ADVFIREWALL IMPORT %DRIVELETTER%:\NICE_SERVER\FIREWALL\VMS_Bosch\Bosch_VMS_SVR_Firewall_Rules_Final.wfw)
IF /I %USER_INPUT%==5 (NETSH ADVFIREWALL IMPORT %DRIVELETTER%:\NICE_SERVER\FIREWALL\VMS_Genetec\Galaxy_VMS_SVR_Firewall_Rules_Final.wfw)
IF /I %USER_INPUT%==6 (NETSH ADVFIREWALL IMPORT %DRIVELETTER%:\NICE_SERVER\FIREWALL\VMS_Milestone\Milestone_VMS_SVR_Firewall_Rules_Final.wfw)
